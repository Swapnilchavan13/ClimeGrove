...
const GallerySection = () => {
  const images = [
    { src: "https://i.postimg.cc/k5hQqZ4r/why_bandhavgarh_national_park_banner_img.jpg", caption: "Tiger spotted near the Bandhavgarh area" },
    ...
    { src: "https://i.postimg.cc/02bnT2rY/Homepage_Slider3_Rice_Straw.png", caption: "A pile of rice straw waiting to be converted into biochar" },
    ...
    { src: "https://i.postimg.cc/k4Fpjqsk/IMG_7388.jpg", caption: "Freshly processed biochar" },
    { src: "https://i.postimg.cc/FFgXYpx2/IMG_7829.jpg", caption: "Bulk biochar ready for soil application" },
    { src: "https://i.postimg.cc/Vk3GgR9d/0F9D9A8C-545B-4B65-B2AE-3CA5C527B854.jpg", caption: "Flame cone set up and ready to produce biochar" },
